...
import com.appbanhang.adapter.TourMienBacAdapter;
...
public class TourMienBacActivity extends AppCompatActivity {
    Toolbar toolbarxct;
    ListView listViewxct;
    TourMienBacAdapter tourMienBacAdapter;
    ArrayList<SanPham> mangxct;
    int idxct = 0;
    //    int page = 1;
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate ( savedInstanceState );
        setContentView ( R.layout.activity_tourmienbac);
        AnhXa();
        listViewxct.setOnItemClickListener ( new AdapterView.OnItemClickListener () {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent (TourMienBacActivity.this, ChiTietActivity.class);
                intent.putExtra ( "chitietsanpham", mangxct.get(position));
                startActivity (intent);
            }
        } );
        if(CheckConnection.haveNetworkConnection ( TourMienBacActivity.this )){
            GetIDLoaiSanPham();
            ActionToolbar();
            //GetData(page);
            Getdata2();
            ...
            CheckConnection.showToast_Short ( TourMienBacActivity.this ,"Bạn hãy kiểm tra lại  kết nối" );
        }

    }

    private void Getdata2() {
        final RequestQueue request = Volley.newRequestQueue(TourMienBacActivity.this);
        JsonArrayRequest json = new JsonArrayRequest( Server.duongdanxecontay,new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        tourMienBacAdapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(TourMienBacActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        request.add(json);
    }
    ...
    private void AnhXa() {
        ...
        tourMienBacAdapter= new TourMienBacAdapter( getApplicationContext (),mangxct );
        listViewxct.setAdapter ( tourMienBacAdapter );
    }
}