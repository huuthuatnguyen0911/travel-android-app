...
public class TourMienTrungAdapter extends BaseAdapter{
    Context context;
    ArrayList<SanPham> arrayxesotudong;

    public TourMienTrungAdapter(Context context, ArrayList<SanPham> arrayxesotudong) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate ( R.layout.dong_tourmientrung, null );
