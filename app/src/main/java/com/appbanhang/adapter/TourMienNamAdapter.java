...
public class TourMienNamAdapter extends BaseAdapter {
    Context context;
    ArrayList<SanPham> arrayxecontudong;

    public TourMienNamAdapter(Context context, ArrayList<SanPham> arrayxecontudong) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
     TourMienNamAdapter.ViewHolder viewHolder = null;
        if (convertView == null){
            viewHolder = new TourMienNamAdapter.ViewHolder ();
            LayoutInflater inflater = (LayoutInflater) context.getSystemService ( Context.LAYOUT_INFLATER_SERVICE );
            convertView = inflater.inflate ( R.layout.dong_tourmiennam, null );
...
//            } );
            ...
            viewHolder = (TourMienNamAdapter.ViewHolder) convertView.getTag ();
        }
