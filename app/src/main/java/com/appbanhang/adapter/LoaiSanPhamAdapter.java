...
//    khi load dữ liệu lần đầu bắt những ánh xạ, những lần sau khi đã có giá trị thì k cần load lại giá trị mà sẽ gán trực tiếp giá trị vào trong những thuộc tính của layout
